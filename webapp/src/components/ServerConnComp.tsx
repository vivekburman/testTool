    ...
    getModalBody = () => {
        ...
        return (
            <form className="tti--margin-top-20">
                <div>
                    <InputText value={serverConfig.host.value} type={serverConfig.host.type} id={serverConfig.host.id} required={serverConfig.host.required} placeholder="0.0.0.0" label="Server Host" isValidInput={this.validateInputs}/>
                    <InputText value={serverConfig.port.value} type={serverConfig.port.type} id={serverConfig.port.id} required={serverConfig.port.required} placeholder="8888" label="Server Port" isValidInput={this.validateInputs}/>
                </div>
